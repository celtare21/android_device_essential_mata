...
# Kernel
BOARD_KERNEL_CMDLINE := androidboot.hardware=mata sched_enable_hmp=1 sched_enable_power_aware=1 androidboot.selinux=permissive ehci-hcd.park=3
...
TARGET_KERNEL_SOURCE := kernel/essential/oem
